						...
						<div class="row fullscreen d-flex align-items-center justify-content-center">
							<div class="banner-content col-lg-10">
                                ...
                                <div class="input-group mb-3 w-50 mx-auto">
                                    <input type="text" id="search" class="form-control search-box " placeholder="Temukan Wisata Impianmu " aria-label="Search" aria-describedby="search-button">
                                    <button class="btn success-btn" type="button" id="search-button" onclick="searchFunction()">Search</button>
                                </div>
							</div>											
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-5 col-md-6 col-sm-6">
								<div class="single-footer-widget">
									<h6>About Us</h6>
									<p>
										We Provide Tour Plans for your most comfortable travel ever. Let yourself dive into the Beauty, Culture &amp; festivals of Lampung. Have You're Good time at Lampung.
									</p>
									<p class="footer-text">
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is created with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/mrjatinchauhan" target="_blank">Ajeng</a>
								</p>	
								</div>
							</div>
							<div class="col-lg-5  col-md-6 col-sm-6">
