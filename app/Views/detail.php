...
<body>
 ...
 <div class="container">
   ...
   <ol class="breadcrumb">
     ...
     <li class="breadcrumb-item">
       <a href="<?= base_url('/places'); ?>">Places</a>
     </li>
   ...
   <div style="position: relative; width: auto; height: 500px;">
       <iframe
         style="position: absolute; top: 0; left: 0; width: 600px; height: 400px; border:0;" loading="lazy"
         allowfullscreen src="<?php echo $data['maps']; ?>">
       </iframe>
   </div>
 ...
 <footer class="py-3 bg-dark">
   <div class="container">
     <p class="m-0 text-center text-white">Copyright &copy; My Lampungku</p>
   </div>
   <!-- /.container -->
 </footer>
